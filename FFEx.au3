...
#include-once
#include <FF.au3>
; Wed Jan 27 16:51:09 CET 2010 @702 /Internet Time/
; by Thorsten Willert
...
; Beschreibung ..: Gibt die Anzahl der Formulare zurÃ¼ck.
; AutoIt Version : V3.3.0.0
...
Func _FFSetValueByName($sName, $sValue = "", $iIndex = 0)
	_FFSetValue($sValue, $sName, "name", $iIndex)
EndFunc   ;==>_FFSetValueByName
; #FUNCTION# ===================================================================
; Name ..........: _FFTabCloseAll
; Description ...: Closes all Tabs except the selected
; Beschreibung ..: SchlieÃŸt alle Tabs, auÃƒÂŸer dem Aktiven.
; AutoIt Version : V3.3.0.0
