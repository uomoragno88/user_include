...
;	<TestClipBoardHyperlinkReSorter.au3>; On a HotKey, will pull Hyperlinks from HTML- or RTF-formatted Clipboard data,
;										; 	sort and resubmit them to the Clipboard (in isolated, sorted format)
;
; Resources:
...
;
; Author: Ascend4nt, Paul Campbell (PaulIA) for original _ClipBoard_GetData() UDF (<ClipBoard.au3>)
; ===============================================================================================================================


#cs
; --------------------------------------
- SAMPLE IE HTML ClipBoard Header text -
Version:1.0
StartHTML:000000185
EndHTML:000008453
StartFragment:000003866
EndFragment:000008417
StartSelection:000003887
EndSelection:000008417
...
;
; Author: Ascen4nt, Paul Campbell (PaulIA) for original _ClipBoard_GetData() UDF (<ClipBoard.au3>)
; ===============================================================================================================================
...
#cs
	...
	; or better (though no @error handling as of AutoIt v3.3.0.0):
...
#ce
	...
	;  for a full HTML ClipBoard data object. We only need to grab 2 fields, so the smaller, the better
